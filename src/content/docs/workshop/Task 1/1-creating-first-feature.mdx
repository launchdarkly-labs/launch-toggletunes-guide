...
Hop back to the feature flag screen, and turn that toggle on! Confirm the feature has been released by seeing the changes happen in real time on the screen.
